                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                      ...
                      onChanged: (v) => setState(() {
                        context.read<NearbyService>().isSharing = v as bool;
                      }),
                      items: const [
                        DropdownMenuItem(
                          value: true,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Switch(
                                  value: form["content"][index]["isRequired"] ??
                                      false,
                                  onChanged: (v) => setState(() =>
                                      form["content"][index]["isRequired"] = v),
                                ),
                              ],
                            ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ListView.builder(
                                  itemCount:
                                      payloads[responseIndex]["content"].length,
                                  shrinkWrap: true,
                                  physics: const NeverScrollableScrollPhysics(),
                                  itemBuilder: (context, questionIndex) {
                                    return Column(
                                      ...
                                      children: [
                                        Text(payloads[responseIndex]['content']
                                            [questionIndex]["title"]),
